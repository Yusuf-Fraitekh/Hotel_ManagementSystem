    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    RoomTagId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomRoomTags", x => new { x.RoomId, x.RoomTagId });
                    table.ForeignKey(
                        name: "FK_RoomRoomTags_RoomTags_RoomTagId",
                        column: x => x.RoomTagId,
                        principalTable: "RoomTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomRoomTags_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomRoomTags_RoomTagId",
                table: "RoomRoomTags",
                column: "RoomTagId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomTags_Name",
                table: "RoomTags",
                column: "Name",
                unique: true);
